      ...
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-md-4">
            <h6 className="fw-bold mb-3" style={{ color: '#ffffff', fontSize: '1rem' }}>
          ...
          <div className="col-md-4">
            ...
            <ul className="list-unstyled small mb-0" style={{ color: '#ffffff', opacity: 0.9, lineHeight: 1.8 }}>
              <li className="mb-1">
                <i className="bi bi-geo-alt-fill me-2" style={{ color: '#ffffff' }}></i>  {/* ✅ Icône ajoutée */}
                Ouagadougou, Burkina Faso
              </li>
              <li className="mb-1">
                <i className="bi bi-envelope-fill me-2" style={{ color: '#ffffff' }}></i>  {/* ✅ Icône ajoutée */}
                contact@expertise-id.com
              </li>
              <li className="mb-1">
                <i className="bi bi-telephone-fill me-2" style={{ color: '#ffffff' }}></i>  {/* ✅ Icône ajoutée */}
                +226 25 65 84 75
              </li>
            </ul>
          </div>
        ...
        <div className="text-center small" style={{ opacity: 0.7 }}>
          ...
          <div>
            ...
            2026 Plateforme Appels d'Offres • <strong style={{ color: '#ffffff' }}>EXPERTISE-ID</strong>
          </div>
        </div>
      </div>
    </footer>
